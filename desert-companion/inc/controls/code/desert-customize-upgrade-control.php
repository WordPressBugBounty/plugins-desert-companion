...
class Desert_Companion_Customize_Upgrade_Control extends WP_Customize_Control {
	...
	protected function render_content() {
		...
		elseif('NewsMunch' == $desert_activated_theme->name || 'NewsTick' == $desert_activated_theme->name  || 'NewsAlert' == $desert_activated_theme->name || 'NewsBlogy' == $desert_activated_theme->name  || 'NewsMemo' == $desert_activated_theme->name):
		...
		elseif('Coviant' == $desert_activated_theme->name):
			$upgrade_to_pro_link = 'https://desertthemes.com/themes/coviant-pro/';	
		...
		elseif('Achrovin' == $desert_activated_theme->name):
			$upgrade_to_pro_link = 'https://desertthemes.com/themes/achrovin-pro/';	
		elseif('Corbit' == $desert_activated_theme->name):
			$upgrade_to_pro_link = 'https://desertthemes.com/themes/corbit-pro/';		
		else:
