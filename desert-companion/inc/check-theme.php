...
if( !function_exists('desert_companion_check_theme') ){
	function desert_companion_check_theme(){
		...
		$desert_themes = array('NewsMash','NewsDaily','DayStory','NewsAlt','NewsHours','AnyNews','NewsOnline','NewsMash Pro','NewsMunch','NewsMunch Pro','NewsTick','NewsAlert','NewsBlogy','NewsMemo');
