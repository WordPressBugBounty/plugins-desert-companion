...
class Desert_Companion_Activator {
	...
	public static function activate() {
		...
		if(!$item_details_page){
			...
			}elseif('Corpiva' == $desert_activated_theme->name  || 'Corvita' == $desert_activated_theme->name  || 'Corvia' == $desert_activated_theme->name  || 'Advancea' == $desert_activated_theme->name  || 'Avanta' == $desert_activated_theme->name  || 'Corvine' == $desert_activated_theme->name  || 'Coviant' == $desert_activated_theme->name  || 'Achrovin' == $desert_activated_theme->name){
			...
			}elseif('Ploto' == $desert_activated_theme->name  ||  'Atromax' == $desert_activated_theme->name  ||  'Corbit' == $desert_activated_theme->name){
