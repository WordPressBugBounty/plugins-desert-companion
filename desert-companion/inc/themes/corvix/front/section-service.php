...
?>
<section id="dt_service" class="dt_information dt_information--eight dt-py-default front-service">
	...
	<div class="dt-container">
		...
		<div class="dt-row dt-g-4">
			<div class="dt-col-lg-12 dt-col-sm-12 dt-col-12 wow fadeInUp animated" data-wow-delay="100ms" data-wow-duration="1500ms">
			...
			?>
					...
					<div class="item-inner">						
						...
						<div class="item-image">
							<a href="<?php echo esc_url( !empty($link) ? $link : '#' ); ?>">
						...
						<div class="item-content">
							...
							<?php endif; ?>
							<?php if ( ! empty( $button ) ) : ?>
							<a href="<?php echo esc_url($link); ?>" class="dt-btn dt-btn-primary"><?php echo wp_kses_post($button); ?> <i class="fal fa-arrow-right-long"></i></a>
							<?php endif; ?>
						</div>
					</div>
			<?php } } ?>
