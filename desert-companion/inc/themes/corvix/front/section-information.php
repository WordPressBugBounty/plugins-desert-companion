...
?>
<section id="dt_information" class="dt_information dt_information--seven dt-py-default front-info2">
	<div id="particles-js-1" class="particles-js-area"></div>
	<div class="dt-container">
		<div class="dt-row dt-g-4 dt_information-row">
			<?php
			...
			?>
				<div class="dt-col-lg-3 dt-col-sm-6 dt-col-12 wow fadeInUp animated" data-wow-delay="<?php echo esc_attr($i*100); ?>ms" data-wow-duration="1500ms">
					<div class="item-inner">
						...
						<?php endif; ?>
						<div class="shape"></div>
						<div class="count"><?php echo esc_html(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></div>
						<?php if ( ! empty( $title ) ) : ?>
							<?php if ( ! empty( $link ) ) : ?>
						...
						<?php endif; ?>
						<div class="item-image"><?php if ( ! empty( $image ) ) : ?><img src="<?php echo esc_url($image); ?>"><?php endif; ?></div>
						<div class="hover-box hover-bx1"></div>
						<div class="hover-box hover-bx2"></div>
						<div class="hover-box hover-bx3"></div>
						<div class="hover-box hover-bx4"></div>
					</div>
				</div>
			<?php } } ?>
		</div>
