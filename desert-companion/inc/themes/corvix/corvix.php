...
require desert_companion_plugin_dir . 'inc/themes/corvix/customizer/chromax-cta-section.php';
...
if ( ! function_exists( 'desert_companion_chromax_frontpage_sections' ) ) :
	function desert_companion_chromax_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/corvix/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/corvix/front/section-information.php';
		require desert_companion_plugin_dir . 'inc/themes/chromax/front/section-about.php';
		require desert_companion_plugin_dir . 'inc/themes/corvix/front/section-service.php';
		require desert_companion_plugin_dir . 'inc/themes/corvix/front/section-cta.php';
