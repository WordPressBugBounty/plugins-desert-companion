...
?>
<section id="dt_information" class="dt_service dt_service--twelve dt-py-default front-info">
					...
					<div class="item-wrap">
						<div class="inner">
							<div class="front-inner">
								<div class="item-inner">
									<div class="item-content-head">
										...
										<?php if ( ! empty( $title ) ) : ?>
											<?php if ( ! empty( $link ) ) : ?>
												<h5 class="item-title"><a href="<?php echo esc_url($link); ?>"><?php echo wp_kses( html_entity_decode( $title ), $allowed_html ); ?></a></h5>
											<?php else: ?>	
							...
							<div class="back-inner">
								<div class="item-inner infohover">
