...
require desert_companion_plugin_dir . 'inc/themes/coviant/front/site-header.php';
...
if ( ! function_exists( 'desert_companion_corpiva_frontpage_sections' ) ) :
	function desert_companion_corpiva_frontpage_sections() {	
		...
		require desert_companion_plugin_dir . 'inc/themes/coviant/front/section-information.php';
		require desert_companion_plugin_dir . 'inc/themes/corpiva/front/section-overview.php';
		require desert_companion_plugin_dir . 'inc/themes/coviant/front/section-service.php';
