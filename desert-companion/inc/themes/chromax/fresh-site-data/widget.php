...
$activate_theme_widget = array(
        'chromax-sidebar-primary' => array(
            'search-1',
            'recent-posts-1',
            'archives-1',
        ),
		'chromax-footer-widget-1' => array(
            'text-1',
        ),
		'chromax-footer-widget-2' => array(
            'text-2',
        ),
		'chromax-footer-widget-3' => array(
            'search-1',
        ),
		'chromax-footer-widget-4' => array(
            'text-3',
        )
    );
	...
	$MediaId = get_option('chromax_media_id');
