<?php
function chromax_slider_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	// Slider 
		$wp_customize->add_setting( 'chromax_slider_option', 
			array(
			 'sanitize_callback' => 'chromax_repeater_sanitize',
			 'priority' => 5,
			  'default' => chromax_slider_options_default()
			)
		);
...
add_action( 'customize_register', 'chromax_slider_customize_setting' );