<?php
function chromax_information_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	// Information 
		$wp_customize->add_setting( 'chromax_information_option', 
			array(
			 'sanitize_callback' => 'chromax_repeater_sanitize',
			 'priority' => 5,
			 'default' => chromax_information_options_default()
			)
		);
	...
	// Upgrade
	$wp_customize->add_setting(
	'chromax_information_option_upsale', 
	array(
		'capability' => 'edit_theme_options',
...
add_action( 'customize_register', 'chromax_information_customize_setting' );