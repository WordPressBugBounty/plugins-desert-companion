...
?>
<section id="dt_service" class="dt_service dt_service--two bg-secondary dt-py-default front-services">
		...
		<?php if ( ! empty( $ploto_service_ttl )  || ! empty( $ploto_service_subttl )  || ! empty( $ploto_service_text )) : ?>
			<div class="dt-row dt-gy-4 align-items-center">
				<div class="dt-col-lg-12">
					<div class="title-wrap dt-text-center text-white dt-mb-6" data-wow-duration="1.5s"
						data-wow-delay=".4s">
			...
			?>
				<div class="dt-col-xl-3 dt-col-lg-4 dt-col-md-6 dt-col-sm-6">
					<div class="service-box">
						<?php if ( ! empty( $image ) ) : ?>
						<div class="thumb overlay-anim4 overflow-hidden">
						...
						<div class="service-top">
							...
							<?php if ( ! empty( $button ) ) : ?>
							<a href="<?php echo esc_url($link); ?>" class="dt-btn dt-btn-gray dt-btn-border">
								<?php echo wp_kses( html_entity_decode( $button ), $allowed_html ); ?> 
