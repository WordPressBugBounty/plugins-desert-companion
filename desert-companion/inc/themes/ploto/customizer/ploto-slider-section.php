<?php
function ploto_slider_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	/*=========================================
	Slider Section Panel
	=========================================*/
	$wp_customize->add_panel(
		'ploto_frontpage_options', array(
			'priority' => 32,
	...
	// Hide/Show Setting
	$wp_customize->add_setting(
		'ploto_slider_options_hide_show'
			,array(
			'default'     	=> '1',
			'capability'     	=> 'edit_theme_options',
	...
	// Slider 
		$wp_customize->add_setting( 'ploto_slider_option', 
			array(
			 'sanitize_callback' => 'ploto_repeater_sanitize',
			 'priority' => 5,
			  'default' => ploto_slider_options_default()
			)
		);
	...
	if ( class_exists( 'Ploto_Customizer_Range_Control' ) ) {
		...
		$wp_customize->add_control( 
		new Ploto_Customizer_Range_Control( $wp_customize, 'ploto_slider_opacity', 
			array(
...
add_action( 'customize_register', 'ploto_slider_customize_setting' );