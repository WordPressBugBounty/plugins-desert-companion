<?php
function ploto_information_customize_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_setting(
		'ploto_information_options_setting'
			,array(
	...
	// Hide/Show Setting
	$wp_customize->add_setting(
		'ploto_information_options_hide_show'
			,array(
			'default'     	=> '1',
			'capability'     	=> 'edit_theme_options',
	...
	// Information 
		$wp_customize->add_setting( 'ploto_information_option', 
			array(
			 'sanitize_callback' => 'ploto_repeater_sanitize',
			 'priority' => 5,
			 'default' => ploto_information_options_default()
			)
		);
	...
	// Upgrade
	$wp_customize->add_setting(
	'ploto_information_option_upsale', 
	array(
		'capability' => 'edit_theme_options',
...
add_action( 'customize_register', 'ploto_information_customize_setting' );