...
$activate_theme_widget = array(
        'ploto-sidebar-primary' => array(
            'search-1',
            'recent-posts-1',
            'archives-1',
        ),
		'ploto-footer-widget-1' => array(
            'text-1',
        ),
		'ploto-footer-widget-2' => array(
            'text-2',
        ),
		'ploto-footer-widget-3' => array(
            'text-3',
        ),
		'ploto-footer-widget-4' => array(
            'text-4',
        )
    );
	...
	update_option('widget_text', array(  
		...
		3 => array('title' => '',
        'text'=>'<aside class="widget widget_contact">
                            <h5 class="widget-title">Reach Out</h5>
                            <div class="contact__list">
                                <div class="contact__body">
                                    <h6 class="title">Email</h6>
                                    <p class="description"><a href="mailto:info@example.com">info@example.com</a></p>
                                </div>
                            </div>
                            <div class="contact__list">
                                <div class="contact__body">
                                    <h6 class="title">Phone</h6>
                                    <p class="description"><a href="tel:15554321098">+1 555 4321 098</a></p>
                                </div>
                            </div>
                            <aside class="widget widget_social dt-mt-4">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fab fa-tiktok" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                                    <li><a href="#"><i class="fab fa-x-twitter" aria-hidden="true"></i></a></li>
	...
	$MediaId = get_option('ploto_media_id');
